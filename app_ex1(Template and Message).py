...
def index():  # put application's code here
    #messaggio all'utente di menvenuto di
    ...
    return render_template("ex1/index.html", first_name= first_name,
...
@app.route('/user/<name>')
def user(name):
    return render_template("ex1/user.html", user_name= name)


# invalid URL
@app.errorhandler(404)
def page_not_found(e):
    return render_template("ex1/404.html"), 404
...
def name():
    ...
    if form.validate_on_submit():
        ...
        # creo un flash message
        flash("Form Submitted Successfully!")


    return render_template("ex1/name.html", name=name,
                           form=form)
